...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GUY-A19a"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-v1",
      "problem_contract_sha256": "735ab08c84579b1ade39d334a95bd33e1dbad0f832b62e517539569b36a7e0b5",
      "problem_id": "problem:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356",
      "route_id": "route:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-source-fidelity-01",
      "graph_id": "graph:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are 4, 7, 15, 21, 45, 75, and 105 the only values of $n$ for which $n - 2^k$ is prime for all $k$ such that $2 \\le 2^k < n$?"
          },
          "statement_sha256": "3b27cefdbbf7a3fc4a37bb1d2720e6498fca3fac0ba679c8fa23c3e87f53e668"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-root",
      "route_id": "route:um-guy-a19a-erd-s-conjecture-on-n-2-k-prime-293bb356-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-guy-a19a-534281da3e8a",
        "url": "https://www.unsolvedmath.com/problems/GUY-A19a"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
